// Authentic 8-bit Retro Terminal Audio Synthesizer (Web Audio API)
...
// 8-bit retro terminal computer blip
...
// Retro terminal link/acknowledgement beep
...
// Mechanical terminal keystroke click
